...
class HomeworkTest {
    ...
    public void withoutElementsEmpty() {
        ...
        assertEquals(expected,homework.withoutEltsMoreThanNIterator(actual,5));

    }
    @Test
    public void withoutElementsNoSuchEmpty() {
        List<Integer> expected = new ArrayList<>();
        ...
        assertEquals(expected,homework.withoutEltsMoreThanNIterator(actual,0));
    ...
    public void withoutElementsSeveral() {
        ...
        assertEquals(expected,homework.withoutEltsMoreThanNIterator(actual,70));
